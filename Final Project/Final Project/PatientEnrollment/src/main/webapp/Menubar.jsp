...
<head>
    ...
    <style>
        /* Style for the horizontal menu bar */
        ul.menu-bar {
        ...
        ul.menu-bar li a, .dropdown-content a {
        ...
        ul.menu-bar li a:hover, .dropdown-content a:hover {
...
<body>
    ...
    <ul class="menu-bar">
        ...
        <li class="dropdown">
        <a href="#">Enroll Pharmacy</a>
        <div class="dropdown-content">
        <a href="NewFile.html">Login</a>
        </div>
        </li>

        <li class="dropdown">
            <a href="#">Enroll Recipient</a>
            <div class="dropdown-content">
                <a href="login.jsp">Login</a>
                <a href="Enrollment.jsp">Sign Up</a>
            </div>
        </li>
      
          <li class="dropdown">
        <a href="#">Enroll Insurance</a>
         <div class="dropdown-content">
        <a href="NewFile.html">Login</a>
       </div>
       </li>
